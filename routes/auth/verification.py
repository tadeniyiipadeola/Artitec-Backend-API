# routes/auth/verification.py
"""
Role selection and onboarding verification endpoints
"""
...
from model.user import Users, Role, validate_role, get_role_display_name
...
from src.schemas import UserOut, RoleSelectionOut, OrgParseOut
